 ...
 */
export function routeTaskToCrew(context) {
 ...
 */
export function getPrimaryCrewForTask(context) {
 ...
 */
export function generateCrewBriefing(context) {
 ...
 */
export function validateCrewCapability(crewIds, taskDomains) {
 ...
 */
export function findCoverageGaps(crewIds, taskDomains) {
    const crewExpertise = new Set();
    for (const crewId of crewIds) {
        const expertise = CREW_EXPERTISE[crewId];
        if (!expertise)
 ...
 */
export function recommendCrewForGaps(gaps) {
 ...
 */
export function generateDetailedCollaborationReport(context) {
 ...
 */
export function inferTaskDomains(description) {
