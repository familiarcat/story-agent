 ...
 */
export async function getCrewSkillManifest(crewId, options) {
    try {
 ...
 */
export async function getAllCrewSkillManifests() {
    try {
        const db = await getDbClient();
 ...
 */
export async function getCrewSkillManifestHistory(crewId, limit = 10) {
    try {
        const db = await getDbClient();
        const { data, error } = await db
            .from('sa_crew_skills')
 ...
 */
export async function getCrewPersona(crewId) {
    try {
        const db = await getDbClient();
        const { data, error } = await db
 ...
 */
export async function getAllCrewPersonas() {
    try {
        const db = await getDbClient();
        const { data, error } = await db
            .from('sa_crew_personas')
 ...
 */
export async function getWorfVetoedTools() {
    try {
        const db = await getDbClient();
        const { data, error } = await db
 ...
 */
export async function getMissionDebriefs(missionId) {
    try {
        const db = await getDbClient();
        const { data, error } = await db
 ...
 */
export async function getRecentMissionDebriefs(limit = 50) {
    try {
        const db = await getDbClient();
        const { data, error } = await db
            .from('sa_mission_debriefs')
 ...
 */
export async function getCrewRosterWithStats() {
    try {
 ...
 */
export async function getStarshipStatus() {
    try {
 ...
 */
export async function getStoriesGroupedByEpic(projectId) {
    try {
        const db = await getDbClient();
