 ...
 */
export async function retrieveDocKnowledge(options) {
 ...
 */
export async function listDocPhases() {
 ...
 */
export async function getRoleGuidance(role, phase) {
    const roleTagMap = {
 ...
 */
export async function searchDocs(keyword, phase) {
    return retrieveDocKnowledge({
        query: keyword,
        phase,
        limit: 10,
