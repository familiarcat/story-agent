...
exports.getSyncAuditLog = getSyncAuditLog;
exports.createSessionJwt = createSessionJwt;
exports.validateSessionJwt = validateSessionJwt;
exports.revokeSession = revokeSession;
exports.sanitizeSyncPayload = sanitizeSyncPayload;
exports.validateSyncMessage = validateSyncMessage;
exports.getSessionInfo = getSessionInfo;
exports.clearExpiredSessions = clearExpiredSessions;
exports.getSyncValidatorMetrics = getSyncValidatorMetrics;
const node_crypto_1 = require("node:crypto");
const worfgate_credentials_js_1 = require("./worfgate-credentials.js");
// ── Constants ─────────────────────────────────────────────────────────────────
 ...
 */
function getSyncAuditLog(options) {
 ...
 */
function createSessionJwt(sessionId, crewId, scopes = ['ui:sync:read', 'ui:sync:write']) {
...
function signJwt(payload) {
    ...
    const cred = (0, worfgate_credentials_js_1.resolveWorfGateCredential)('CREW_LLM_APPROVED_KEY', {
        operation: 'llm:call',
        crewId: 'worf',
    });
    ...
    const signature = (0, node_crypto_1.createHmac)('sha256', cred.value).update(message).digest('base64url');
...
function verifyJwtSignature(token) {
    ...
    try {
        ...
        // Verify signature
        const message = `${headerB64}.${payloadB64}`;
        const expectedSignature = (0, node_crypto_1.createHmac)('sha256', cred.value)
            .update(message)
            .digest('base64url');
 ...
 */
function validateSessionJwt(token, sessionId) {
    // Verify signature
 ...
 */
function detectSyncInjectionSignals(payload) {
 ...
 */
function validateSyncMessage(token, sessionId, payload, operation = 'ui:sync:write', messageId) {
 ...
 */
function getSyncValidatorMetrics() {
    return {
...
//# sourceMappingURL=worfgate-sync-validator.js.map