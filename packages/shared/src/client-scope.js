...
exports.inferClientIdFromStory = inferClientIdFromStory;
exports.buildClientAccessContext = buildClientAccessContext;
exports.evaluateControlledDataAccess = evaluateControlledDataAccess;
exports.redactControlledStoryFields = redactControlledStoryFields;
...
function inferClientIdFromStory(story) {
...
function buildClientAccessContext(input) {
    return {
...
function evaluateControlledDataAccess(input) {
...
function redactControlledStoryFields(story) {
    return {
        ...story,
        storyUrl: '',
        prUrl: null,
...
//# sourceMappingURL=client-scope.js.map