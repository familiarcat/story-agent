...
exports.CREW_EXPERTISE = void 0;
exports.getCrewExpertise = getCrewExpertise;
exports.generateCrewExpertiseSummary = generateCrewExpertiseSummary;
exports.CREW_EXPERTISE = {
    picard: {
        crewId: 'picard',
 ...
 */
function getCrewExpertise(crewId) {
    return exports.CREW_EXPERTISE[crewId] || null;
}
/**
 * Generate crew expertise summary
 */
function generateCrewExpertiseSummary() {
    const summary = {};
    for (const [crewId, expertise] of Object.entries(exports.CREW_EXPERTISE)) {
        summary[crewId] = {
...
//# sourceMappingURL=crew-expertise.js.map