...
export default function NavBar() {
  return (
    <nav style={{ background: lcars.black, color: lcars.text, fontFamily: MONO, padding: '6px 10px', display: 'flex', gap: '0.9rem', alignItems: 'stretch', flexWrap: 'wrap', letterSpacing: '0.03em' }}>
      <a href="/" style={{ background: lcars.neonCarrot, color: lcars.black, textDecoration: 'none', fontWeight: 800, fontSize: '0.85rem', padding: '8px 14px', borderTopLeftRadius: 18, borderBottomLeftRadius: 6, borderTopRightRadius: 6, borderBottomRightRadius: 6, textTransform: 'uppercase', display: 'flex', alignItems: 'center' }}>
        🖖 Story Agent
      </a>
      ...
      <a href="/docs" style={{ color: lcars.textDim, textDecoration: 'none', marginLeft: 'auto', fontSize: '0.72rem', alignSelf: 'center', textTransform: 'uppercase' }}>LCARS v1.0.0</a>
    </nav>
  );
}
