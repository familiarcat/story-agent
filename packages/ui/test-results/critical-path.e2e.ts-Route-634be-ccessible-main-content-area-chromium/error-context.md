...
- Name: critical-path.e2e.ts >> Route Navigation - Critical Paths >> /observation-lounge should have accessible main content area
- Location: src/__tests__/critical-path.e2e.ts:56:9
...
Call log:
  - navigating to "http://localhost:3000/observation-lounge", waiting until "load"
