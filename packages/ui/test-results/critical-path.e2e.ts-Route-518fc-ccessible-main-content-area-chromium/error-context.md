...
- Name: critical-path.e2e.ts >> Route Navigation - Critical Paths >> /story/new should have accessible main content area
...
Call log:
  - navigating to "http://localhost:3000/story/new", waiting until "load"
