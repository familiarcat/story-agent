...
- Name: critical-path.e2e.ts >> Route Navigation - Critical Paths >> /crew/observations should have accessible main content area
...
Call log:
  - navigating to "http://localhost:3000/crew/observations", waiting until "load"
