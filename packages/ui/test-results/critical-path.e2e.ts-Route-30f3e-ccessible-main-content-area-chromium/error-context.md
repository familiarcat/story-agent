...
- Name: critical-path.e2e.ts >> Route Navigation - Critical Paths >> /cost should have accessible main content area
...
Call log:
  - navigating to "http://localhost:3000/cost", waiting until "load"
